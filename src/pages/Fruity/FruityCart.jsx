  ...
  return (
    <div className="bg-slate-100 rounded">
        ...
        <ul>
          ...
          {fruit.length === 0 && <li className="px-5 py-2 text-xl font-semibold">... Grab one fruit!</li>}
        </ul>
        <p className="text-xl p-5 border-t border-slate-400">
            Total price : <span className="font-semibold">{fruit.reduce((acc, item)=>item.price*item.quantity + acc,0)}$</span>
        </p>
    </div>
  )
}